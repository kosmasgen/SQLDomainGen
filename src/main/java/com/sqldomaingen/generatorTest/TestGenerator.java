...
public class TestGenerator {
    ...
    public void generateTests(
        ...
        serviceImplTestGenerator.generateServiceImplTests(tables, entities, outputDir, basePackage, overwrite);
        mapperTestGenerator.generateMapperTests(tables, entities, outputDir, basePackage, overwrite);
        entityPojoTestGenerator.generateEntityPojoTests(entities, outputDir, basePackage, overwrite);
        dtoPojoTestGenerator.generateDtoPojoTests(entities, outputDir, basePackage, overwrite);
    ...
    public void generateAllTests(
        ...
        generateTests(tables, entities, outputDir, basePackage, true);
    }
}