...
public class PostgreSQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__112", "T__113", "T__114", "T__115", "T__116", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "SEMICOLON", "COLON", "DOUBLE_COLON", "COMMA", "DOUBLE_QUOTE", 
			"ON", "DELETE", "RULE", "DO", "AS", "TO", "INSTEAD", "NOTHING", "FOR", 
			"SELECT", "USING", "DOLLAR_QUOTE", "NEW", "TABLE", "CREATE", "RELATIONSHIP", 
			"DECIMAL", "INT", "VARCHAR", "DOT", "CONSTRAINT", "NULL", "NOT", "IS", 
			"SET", "REFERENCES", "SERIAL", "PRIMARY_KEY", "CHECK", "ANY", "LBRACKET", 
			"RBRACKET", "ARRAY", "DEFAULT", "NEXTVAL", "REGCLASS", "CASCADE", "SET_NULL", 
			"SET_DEFAULT", "NO_ACTION", "RESTRICT", "ON_DELETE", "ON_UPDATE", "UNIQUE", 
			"EQUALS", "TEXT", "INTEGER", "BOOLEAN", "FOREIGN_KEY", "TRIGGER", "BEFORE", 
			"AFTER", "UPDATE", "INSERT", "EACH", "ROW", "EXECUTE", "FUNCTION", "IN", 
			"BETWEEN", "AND", "LIKE", "ILIKE", "PRIMARY", "KEY", "FOREIGN", "EXCLUDE", 
			"BIGSERIAL", "JSONB", "TIMESTAMP", "INDEX", "NOW", "FLOAT8", "FLOAT4", 
			"INT8", "SMALLINT", "BIGINT", "SMALLSERIAL", "REAL", "DOUBLE", "PRECISION", 
			"NUMERIC", "MONEY", "CHAR", "CHARACTER", "JSON", "DATE", "TIME", "INTERVAL", 
			"UUID", "BYTEA", "ENUM", "CITEXT", "TSVECTOR", "INET", "CIDR", "MACADDR", 
			"XML", "PG_LSN", "BIT", "VARBIT", "VARYING", "BPCHAR", "WITHOUT", "WITH", 
			"ZONE", "MANYTOMANY", "IDENTIFIER", "STRING", "NUMBER", "DIGIT", "LINE_COMMENT", 
			"BLOCK_COMMENT", "WS"
		};
	}
