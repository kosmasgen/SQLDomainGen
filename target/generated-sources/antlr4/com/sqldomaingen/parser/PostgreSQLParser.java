...
public class PostgreSQLParser extends Parser {
	...
	public static final int
		...
		T__149=150, T__150=151, T__151=152, T__152=153, LPAREN=154, RPAREN=155, 
		LBRACE=156, RBRACE=157, SEMICOLON=158, COLON=159, DOUBLE_COLON=160, COMMA=161, 
		DOUBLE_QUOTE=162, ON=163, DELETE=164, RULE=165, DO=166, AS=167, TO=168, 
		INSTEAD=169, NOTHING=170, FOR=171, SELECT=172, USING=173, DOLLAR_QUOTE=174, 
		NEW=175, TABLE=176, CREATE=177, RELATIONSHIP=178, DECIMAL=179, INT=180, 
		VARCHAR=181, DOT=182, CONSTRAINT=183, NULL=184, NOT=185, SET=186, REFERENCES=187, 
		AUTO_INCREMENT=188, PRIMARY_KEY=189, CHECK=190, ANY=191, LBRACKET=192, 
		RBRACKET=193, ARRAY=194, DEFAULT=195, NEXTVAL=196, REGCLASS=197, CASCADE=198, 
		SET_NULL=199, SET_DEFAULT=200, NO_ACTION=201, RESTRICT=202, ON_DELETE=203, 
		ON_UPDATE=204, UNIQUE=205, EQUALS=206, TEXT=207, INTEGER=208, BOOLEAN=209, 
		FOREIGN_KEY=210, NOT_NULL=211, IDENTIFIER=212, STRING=213, NUMBER=214, 
		DIGIT=215, WS=216;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'BIT'", "'VARBIT'", "'CURRENT_TIMESTAMP'", "'ON CONFLICT'", "'EXCLUDE'", 
			...
			"'REMAINDER'", "'INDEX'", "'TRUE'", "'FALSE'", "'current_user'", "'now'", 
			"'infinity'", "'NaN'", "'POLICY'", "'ALL'", "'WITH CHECK'", "'BEGIN'", 
			"'END'", "'RETURN'", "'INSTEAD NOTHING'", "'('", "')'", "'{'", "'}'", 
			"';'", "':'", "'::'", "','", "'\"'", "'ON'", "'DELETE'", "'RULE'", "'DO'", 
			"'AS'", "'TO'", "'INSTEAD'", "'NOTHING'", "'FOR'", "'SELECT'", "'USING'", 
			"'$$'", "'NEW'", "'TABLE'", "'CREATE'", "'RELATIONSHIP'", "'DECIMAL'", 
			"'INT'", "'VARCHAR'", "'.'", "'CONSTRAINT'", "'NULL'", "'NOT'", "'SET'", 
			"'REFERENCES'", "'AUTO_INCREMENT'", "'PRIMARY KEY'", "'CHECK'", "'ANY'", 
			"'['", "']'", "'ARRAY'", "'DEFAULT'", "'nextval'", "'regclass'", "'CASCADE'", 
			"'SET NULL'", "'SET DEFAULT'", "'NO ACTION'", "'RESTRICT'", "'ON DELETE'", 
			"'ON UPDATE'", "'UNIQUE'", "'='", "'TEXT'", "'INTEGER'", "'BOOLEAN'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NULL", "NOT", "SET", "REFERENCES", "AUTO_INCREMENT", "PRIMARY_KEY", 
			...
			"FOREIGN_KEY", "NOT_NULL", "IDENTIFIER", "STRING", "NUMBER", "DIGIT", 
			"WS"
		};
	}
	...
	public final ColumnDefContext columnDef() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__72 || ((((_la - 184)) & ~0x3f) == 0 && ((1L << (_la - 184)) & 203425913L) != 0)) {
					{
					{
					setState(187);
					constraint();
	...
	public final OnDeleteActionContext onDeleteAction() throws RecognitionException {
		...
		try {
			...
			setState(437);
			_la = _input.LA(1);
			if ( !(((((_la - 198)) & ~0x3f) == 0 && ((1L << (_la - 198)) & 15L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class ConstraintContext extends ParserRuleContext {
		...
		public TerminalNode AUTO_INCREMENT() { return getToken(PostgreSQLParser.AUTO_INCREMENT, 0); }
	...
	public final ActionContext action() throws RecognitionException {
		...
		try {
			...
			setState(582);
			_la = _input.LA(1);
			if ( !(((((_la - 198)) & ~0x3f) == 0 && ((1L << (_la - 198)) & 31L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TriggerStatementContext triggerStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__57 || _la==T__70 || ((((_la - 141)) & ~0x3f) == 0 && ((1L << (_la - 141)) & 9015995347763263L) != 0) || _la==STRING || _la==NUMBER) {
				{
				setState(595);
				value();
				setState(600);
	...
	public final CreatePolicyStatementContext createPolicyStatement() throws RecognitionException {
		...
		try {
			...
			if (_la==FOR) {
				...
				setState(1055);
				_la = _input.LA(1);
				if ( !(_la==T__83 || _la==T__84 || ((((_la - 148)) & ~0x3f) == 0 && ((1L << (_la - 148)) & 16842753L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final PlpgsqlBlockContext plpgsqlBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 152)) & ~0x3f) == 0 && ((1L << (_la - 152)) & 1152921504615235585L) != 0)) {
				{
				{
				setState(1075);
				statement();
