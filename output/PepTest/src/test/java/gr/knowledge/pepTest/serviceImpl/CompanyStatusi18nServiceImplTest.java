...
class CompanyStatusi18nServiceImplTest {
    ...
    void shouldReturnMappedDtoWhenGetCompanyStatusi18nByIdIsCalled() {
        ...
        given(companyStatusi18nRepository.findById(id)).willReturn(Optional.of(companyStatusi18n));
        ...
        verify(companyStatusi18nRepository).findById(id);
    ...
    void shouldThrowWhenGetCompanyStatusi18nByIdCannotFindEntity() {
        ...
        given(companyStatusi18nRepository.findById(id)).willReturn(Optional.empty());
    ...
    void shouldUpdateCompanyStatusi18nWhenEntityExists() {
        ...
        given(companyStatusi18nRepository.findById(id)).willReturn(Optional.of(existingEntity));
    ...
    void shouldDeleteCompanyStatusi18nWhenEntityExists() {
        ...
        verify(companyStatusi18nRepository).findById(id);
        verify(companyStatusi18nRepository).deleteById(id);
    }
    ...
    void shouldThrowWhenDeleteCompanyStatusi18nCannotFindEntity() {
        ...
        verify(companyStatusi18nRepository).findById(id);
        verify(companyStatusi18nRepository, never()).deleteById(id);
    }
