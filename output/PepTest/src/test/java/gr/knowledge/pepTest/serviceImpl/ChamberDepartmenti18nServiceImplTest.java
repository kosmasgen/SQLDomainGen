...
class ChamberDepartmenti18nServiceImplTest {
    ...
    void shouldReturnMappedDtoWhenGetChamberDepartmenti18nByIdIsCalled() {
        ...
        given(chamberDepartmenti18nRepository.findById(id)).willReturn(Optional.of(chamberDepartmenti18n));
        ...
        verify(chamberDepartmenti18nRepository).findById(id);
    ...
    void shouldThrowWhenGetChamberDepartmenti18nByIdCannotFindEntity() {
        ...
        given(chamberDepartmenti18nRepository.findById(id)).willReturn(Optional.empty());
    ...
    void shouldUpdateChamberDepartmenti18nWhenEntityExists() {
        ...
        given(chamberDepartmenti18nRepository.findById(id)).willReturn(Optional.of(existingEntity));
    ...
    void shouldDeleteChamberDepartmenti18nWhenEntityExists() {
        ...
        verify(chamberDepartmenti18nRepository).findById(id);
        verify(chamberDepartmenti18nRepository).deleteById(id);
    }
    ...
    void shouldThrowWhenDeleteChamberDepartmenti18nCannotFindEntity() {
        ...
        verify(chamberDepartmenti18nRepository).findById(id);
        verify(chamberDepartmenti18nRepository, never()).deleteById(id);
    }
