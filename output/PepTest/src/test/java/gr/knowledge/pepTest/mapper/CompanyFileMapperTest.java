...
class CompanyFileMapperTest {
    ...
    void setUp() {
        ...
        companyFileMapper = new CompanyFileMapper(modelMapper);
    }
     ...
     */
    @Test
    void shouldMapCompanyFileToCompanyFileDto() {
        CompanyFile entity = createSampleCompanyFileEntity();
        CompanyFileDto expectedDto = createSampleCompanyFileDto();

        CompanyFileDto actualDto = companyFileMapper.toDTO(entity);
     ...
     */
    @Test
    void shouldMapCompanyFileDtoToCompanyFile() {
        CompanyFileDto dto = createSampleCompanyFileDto();
        CompanyFile expectedEntity = createSampleCompanyFileEntity();

        CompanyFile actualEntity = companyFileMapper.toEntity(dto);
     ...
     */
    @Test
    void shouldMapCompanyFileListToCompanyFileDtoList() {
        List<CompanyFile> entityList = List.of(
                createSampleCompanyFileEntity(),
                createAnotherCompanyFileEntity()
        );
        List<CompanyFileDto> expectedDtoList = List.of(
                createSampleCompanyFileDto(),
                createAnotherCompanyFileDto()
        );

        List<CompanyFileDto> actualDtoList = companyFileMapper.toDTOList(entityList);
     ...
     */
    @Test
    void shouldMapCompanyFileDtoListToCompanyFileList() {
        List<CompanyFileDto> dtoList = List.of(
                createSampleCompanyFileDto(),
                createAnotherCompanyFileDto()
        );
        List<CompanyFile> expectedEntityList = List.of(
                createSampleCompanyFileEntity(),
                createAnotherCompanyFileEntity()
        );

        List<CompanyFile> actualEntityList = companyFileMapper.toEntityList(dtoList);
     ...
     */
    @Test
    void shouldApplyFullPartialUpdateForCompanyFile() {
        CompanyFile originalEntity = createSampleCompanyFileEntity();
        CompanyFile actualEntity = createSampleCompanyFileEntity();
        CompanyFileDto patchDto = createPatchCompanyFileDto();
        CompanyFile patchEntity = companyFileMapper.toEntity(patchDto);

        companyFileMapper.partialUpdate(actualEntity, patchDto);
        ...
        Object isLogoExpectedValue = patchEntity.getIsLogo() != null ? patchEntity.getIsLogo() : originalEntity.getIsLogo();
        assertThat(actualEntity.getIsLogo())
                .isEqualTo(isLogoExpectedValue);

        Object isBackgroundExpectedValue = patchEntity.getIsBackground() != null ? patchEntity.getIsBackground() : originalEntity.getIsBackground();
        assertThat(actualEntity.getIsBackground())
                .isEqualTo(isBackgroundExpectedValue);
        ...
        Object isEmbeddedExpectedValue = patchEntity.getIsEmbedded() != null ? patchEntity.getIsEmbedded() : originalEntity.getIsEmbedded();
        assertThat(actualEntity.getIsEmbedded())
                .isEqualTo(isEmbeddedExpectedValue);
     ...
     */
    @Test
    void shouldReturnEmptyCompanyFileDtoListForNullOrEmptyCompanyFileList() {
        assertThat(companyFileMapper.toDTOList(null)).isEmpty();
        assertThat(companyFileMapper.toDTOList(List.of())).isEmpty();
    }
     ...
     */
    @Test
    void shouldReturnEmptyCompanyFileListForNullOrEmptyCompanyFileDtoList() {
        assertThat(companyFileMapper.toEntityList(null)).isEmpty();
        assertThat(companyFileMapper.toEntityList(List.of())).isEmpty();
    }
    ...
    void shouldIgnoreNullArgumentsInPartialUpdate() {
        ...
        companyFileMapper.partialUpdate(entity, null);
        companyFileMapper.partialUpdate(null, createPatchCompanyFileDto());
    ...
    /**
     * Creates a populated CompanyFile fixture for mapper tests.
     *
    ...
    /**
     * Creates a populated CompanyFileDto fixture for mapper tests.
     *
