...
class WorkingHoursMapperTest {
    ...
    void setUp() {
        ...
        workingHoursMapper = new WorkingHoursMapper(modelMapper);
    }
     ...
     */
    @Test
    void shouldMapWorkingHoursToWorkingHoursDto() {
        WorkingHours entity = createSampleWorkingHoursEntity();
        WorkingHoursDto expectedDto = createSampleWorkingHoursDto();

        WorkingHoursDto actualDto = workingHoursMapper.toDTO(entity);
     ...
     */
    @Test
    void shouldMapWorkingHoursDtoToWorkingHours() {
        WorkingHoursDto dto = createSampleWorkingHoursDto();
        WorkingHours expectedEntity = createSampleWorkingHoursEntity();

        WorkingHours actualEntity = workingHoursMapper.toEntity(dto);
     ...
     */
    @Test
    void shouldMapWorkingHoursListToWorkingHoursDtoList() {
        List<WorkingHours> entityList = List.of(
                createSampleWorkingHoursEntity(),
                createAnotherWorkingHoursEntity()
        );
        List<WorkingHoursDto> expectedDtoList = List.of(
                createSampleWorkingHoursDto(),
                createAnotherWorkingHoursDto()
        );

        List<WorkingHoursDto> actualDtoList = workingHoursMapper.toDTOList(entityList);
     ...
     */
    @Test
    void shouldMapWorkingHoursDtoListToWorkingHoursList() {
        List<WorkingHoursDto> dtoList = List.of(
                createSampleWorkingHoursDto(),
                createAnotherWorkingHoursDto()
        );
        List<WorkingHours> expectedEntityList = List.of(
                createSampleWorkingHoursEntity(),
                createAnotherWorkingHoursEntity()
        );

        List<WorkingHours> actualEntityList = workingHoursMapper.toEntityList(dtoList);
     ...
     */
    @Test
    void shouldApplyFullPartialUpdateForWorkingHours() {
        WorkingHours originalEntity = createSampleWorkingHoursEntity();
        WorkingHours actualEntity = createSampleWorkingHoursEntity();
        WorkingHoursDto patchDto = createPatchWorkingHoursDto();
        WorkingHours patchEntity = workingHoursMapper.toEntity(patchDto);

        workingHoursMapper.partialUpdate(actualEntity, patchDto);
        ...
        Object dayOfWeekExpectedValue = patchEntity.getDayOfWeek() != null ? patchEntity.getDayOfWeek() : originalEntity.getDayOfWeek();
        assertThat(actualEntity.getDayOfWeek())
                .isEqualTo(dayOfWeekExpectedValue);

        Object openingTimeExpectedValue = patchEntity.getOpeningTime() != null ? patchEntity.getOpeningTime() : originalEntity.getOpeningTime();
        assertThat(actualEntity.getOpeningTime())
                .isEqualTo(openingTimeExpectedValue);

        Object closingTimeExpectedValue = patchEntity.getClosingTime() != null ? patchEntity.getClosingTime() : originalEntity.getClosingTime();
        assertThat(actualEntity.getClosingTime())
                .isEqualTo(closingTimeExpectedValue);

        Object isClosedExpectedValue = patchEntity.getIsClosed() != null ? patchEntity.getIsClosed() : originalEntity.getIsClosed();
        assertThat(actualEntity.getIsClosed())
                .isEqualTo(isClosedExpectedValue);
     ...
     */
    @Test
    void shouldReturnEmptyWorkingHoursDtoListForNullOrEmptyWorkingHoursList() {
        assertThat(workingHoursMapper.toDTOList(null)).isEmpty();
        assertThat(workingHoursMapper.toDTOList(List.of())).isEmpty();
    }
     ...
     */
    @Test
    void shouldReturnEmptyWorkingHoursListForNullOrEmptyWorkingHoursDtoList() {
        assertThat(workingHoursMapper.toEntityList(null)).isEmpty();
        assertThat(workingHoursMapper.toEntityList(List.of())).isEmpty();
    }
    ...
    void shouldIgnoreNullArgumentsInPartialUpdate() {
        ...
        workingHoursMapper.partialUpdate(entity, null);
        workingHoursMapper.partialUpdate(null, createPatchWorkingHoursDto());
    ...
    /**
     * Creates a populated WorkingHours fixture for mapper tests.
     *
    ...
    private WorkingHours createSampleWorkingHoursEntity() {
        ...
        entity.setDayOfWeek("dayOfWeekValue1");
        entity.setOpeningTime(LocalTime.of(9, 6, 3));
        entity.setClosingTime(LocalTime.of(9, 6, 3));
    ...
    private WorkingHours createAnotherWorkingHoursEntity() {
        ...
        entity.setDayOfWeek("dayOfWeekValue2");
        entity.setOpeningTime(LocalTime.of(10, 7, 4));
        entity.setClosingTime(LocalTime.of(10, 7, 4));
    ...
    /**
     * Creates a populated WorkingHoursDto fixture for mapper tests.
     *
    ...
    private WorkingHoursDto createSampleWorkingHoursDto() {
        ...
        dto.setDayOfWeek("dayOfWeekValue1");
        dto.setOpeningTime(LocalTime.of(9, 6, 3));
        dto.setClosingTime(LocalTime.of(9, 6, 3));
    ...
    private WorkingHoursDto createAnotherWorkingHoursDto() {
        ...
        dto.setDayOfWeek("dayOfWeekValue2");
        dto.setOpeningTime(LocalTime.of(10, 7, 4));
        dto.setClosingTime(LocalTime.of(10, 7, 4));
    ...
    private WorkingHoursDto createPatchWorkingHoursDto() {
        WorkingHoursDto dto = new WorkingHoursDto();
        dto.setDayOfWeek("dayOfWeekValue3");
        dto.setClosingTime(LocalTime.of(11, 8, 5));
        dto.setIsClosed(true);
