...
class CompanyYpArticleI18nServiceImplTest {
    ...
    void shouldReturnMappedDtoWhenGetCompanyYpArticleI18nByIdIsCalled() {
        ...
        given(companyYpArticleI18nRepository.findById(id)).willReturn(Optional.of(companyYpArticleI18n));
        ...
        verify(companyYpArticleI18nRepository).findById(id);
    ...
    void shouldThrowWhenGetCompanyYpArticleI18nByIdCannotFindEntity() {
        ...
        given(companyYpArticleI18nRepository.findById(id)).willReturn(Optional.empty());
    ...
    void shouldUpdateCompanyYpArticleI18nWhenEntityExists() {
        ...
        given(companyYpArticleI18nRepository.findById(id)).willReturn(Optional.of(existingEntity));
    ...
    void shouldDeleteCompanyYpArticleI18nWhenEntityExists() {
        ...
        verify(companyYpArticleI18nRepository).findById(id);
        verify(companyYpArticleI18nRepository).deleteById(id);
    }
    ...
    void shouldThrowWhenDeleteCompanyYpArticleI18nCannotFindEntity() {
        ...
        verify(companyYpArticleI18nRepository).findById(id);
        verify(companyYpArticleI18nRepository, never()).deleteById(id);
    }
