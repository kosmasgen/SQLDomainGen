...
class CompanyProfileI18nServiceImplTest {
    ...
    void shouldReturnMappedDtoWhenGetCompanyProfileI18nByIdIsCalled() {
        ...
        given(companyProfileI18nRepository.findById(id)).willReturn(Optional.of(companyProfileI18n));
        ...
        verify(companyProfileI18nRepository).findById(id);
    ...
    void shouldThrowWhenGetCompanyProfileI18nByIdCannotFindEntity() {
        ...
        given(companyProfileI18nRepository.findById(id)).willReturn(Optional.empty());
    ...
    void shouldUpdateCompanyProfileI18nWhenEntityExists() {
        ...
        given(companyProfileI18nRepository.findById(id)).willReturn(Optional.of(existingEntity));
    ...
    void shouldDeleteCompanyProfileI18nWhenEntityExists() {
        ...
        verify(companyProfileI18nRepository).findById(id);
        verify(companyProfileI18nRepository).deleteById(id);
    }
    ...
    void shouldThrowWhenDeleteCompanyProfileI18nCannotFindEntity() {
        ...
        verify(companyProfileI18nRepository).findById(id);
        verify(companyProfileI18nRepository, never()).deleteById(id);
    }
