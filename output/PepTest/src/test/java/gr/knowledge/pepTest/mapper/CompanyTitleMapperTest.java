...
class CompanyTitleMapperTest {
    ...
    void setUp() {
        ...
        companyTitleMapper = new CompanyTitleMapper(modelMapper);
    }
     ...
     */
    @Test
    void shouldMapCompanyTitleToCompanyTitleDto() {
        CompanyTitle entity = createSampleCompanyTitleEntity();
        CompanyTitleDto expectedDto = createSampleCompanyTitleDto();

        CompanyTitleDto actualDto = companyTitleMapper.toDTO(entity);
     ...
     */
    @Test
    void shouldMapCompanyTitleDtoToCompanyTitle() {
        CompanyTitleDto dto = createSampleCompanyTitleDto();
        CompanyTitle expectedEntity = createSampleCompanyTitleEntity();

        CompanyTitle actualEntity = companyTitleMapper.toEntity(dto);
     ...
     */
    @Test
    void shouldMapCompanyTitleListToCompanyTitleDtoList() {
        List<CompanyTitle> entityList = List.of(
                createSampleCompanyTitleEntity(),
                createAnotherCompanyTitleEntity()
        );
        List<CompanyTitleDto> expectedDtoList = List.of(
                createSampleCompanyTitleDto(),
                createAnotherCompanyTitleDto()
        );

        List<CompanyTitleDto> actualDtoList = companyTitleMapper.toDTOList(entityList);
     ...
     */
    @Test
    void shouldMapCompanyTitleDtoListToCompanyTitleList() {
        List<CompanyTitleDto> dtoList = List.of(
                createSampleCompanyTitleDto(),
                createAnotherCompanyTitleDto()
        );
        List<CompanyTitle> expectedEntityList = List.of(
                createSampleCompanyTitleEntity(),
                createAnotherCompanyTitleEntity()
        );

        List<CompanyTitle> actualEntityList = companyTitleMapper.toEntityList(dtoList);
     ...
     */
    @Test
    void shouldApplyFullPartialUpdateForCompanyTitle() {
        CompanyTitle originalEntity = createSampleCompanyTitleEntity();
        CompanyTitle actualEntity = createSampleCompanyTitleEntity();
        CompanyTitleDto patchDto = createPatchCompanyTitleDto();
        CompanyTitle patchEntity = companyTitleMapper.toEntity(patchDto);

        companyTitleMapper.partialUpdate(actualEntity, patchDto);
        ...
        Object chamberTitleIdExpectedValue = patchEntity.getChamberTitleId() != null ? patchEntity.getChamberTitleId() : originalEntity.getChamberTitleId();
        assertThat(actualEntity.getChamberTitleId())
                .isEqualTo(chamberTitleIdExpectedValue);
     ...
     */
    @Test
    void shouldReturnEmptyCompanyTitleDtoListForNullOrEmptyCompanyTitleList() {
        assertThat(companyTitleMapper.toDTOList(null)).isEmpty();
        assertThat(companyTitleMapper.toDTOList(List.of())).isEmpty();
    }
     ...
     */
    @Test
    void shouldReturnEmptyCompanyTitleListForNullOrEmptyCompanyTitleDtoList() {
        assertThat(companyTitleMapper.toEntityList(null)).isEmpty();
        assertThat(companyTitleMapper.toEntityList(List.of())).isEmpty();
    }
    ...
    void shouldIgnoreNullArgumentsInPartialUpdate() {
        ...
        companyTitleMapper.partialUpdate(entity, null);
        companyTitleMapper.partialUpdate(null, createPatchCompanyTitleDto());
    ...
    /**
     * Creates a populated CompanyTitle fixture for mapper tests.
     *
    ...
    private CompanyTitle createSampleCompanyTitleEntity() {
        ...
        entity.setChamberTitleId(new BigInteger("1000"));
    ...
    private CompanyTitle createAnotherCompanyTitleEntity() {
        ...
        entity.setChamberTitleId(new BigInteger("2000"));
    ...
    /**
     * Creates a populated CompanyTitleDto fixture for mapper tests.
     *
    ...
    private CompanyTitleDto createSampleCompanyTitleDto() {
        ...
        dto.setChamberTitleId(new BigInteger("1000"));
    ...
    private CompanyTitleDto createAnotherCompanyTitleDto() {
        ...
        dto.setChamberTitleId(new BigInteger("2000"));
    ...
    private CompanyTitleDto createPatchCompanyTitleDto() {
        CompanyTitleDto dto = new CompanyTitleDto();
        dto.setChamberId(30);
        dto.setChamberTitleId(new BigInteger("3000"));
