...
class UserGeodataMapperTest {
    ...
    void setUp() {
        ...
        userGeodataMapper = new UserGeodataMapper(modelMapper);
    }
     ...
     */
    @Test
    void shouldMapUserGeodataToUserGeodataDto() {
        UserGeodata entity = createSampleUserGeodataEntity();
        UserGeodataDto expectedDto = createSampleUserGeodataDto();

        UserGeodataDto actualDto = userGeodataMapper.toDTO(entity);
     ...
     */
    @Test
    void shouldMapUserGeodataDtoToUserGeodata() {
        UserGeodataDto dto = createSampleUserGeodataDto();
        UserGeodata expectedEntity = createSampleUserGeodataEntity();

        UserGeodata actualEntity = userGeodataMapper.toEntity(dto);
     ...
     */
    @Test
    void shouldMapUserGeodataListToUserGeodataDtoList() {
        List<UserGeodata> entityList = List.of(
                createSampleUserGeodataEntity(),
                createAnotherUserGeodataEntity()
        );
        List<UserGeodataDto> expectedDtoList = List.of(
                createSampleUserGeodataDto(),
                createAnotherUserGeodataDto()
        );

        List<UserGeodataDto> actualDtoList = userGeodataMapper.toDTOList(entityList);
     ...
     */
    @Test
    void shouldMapUserGeodataDtoListToUserGeodataList() {
        List<UserGeodataDto> dtoList = List.of(
                createSampleUserGeodataDto(),
                createAnotherUserGeodataDto()
        );
        List<UserGeodata> expectedEntityList = List.of(
                createSampleUserGeodataEntity(),
                createAnotherUserGeodataEntity()
        );

        List<UserGeodata> actualEntityList = userGeodataMapper.toEntityList(dtoList);
     ...
     */
    @Test
    void shouldApplyFullPartialUpdateForUserGeodata() {
        UserGeodata originalEntity = createSampleUserGeodataEntity();
        UserGeodata actualEntity = createSampleUserGeodataEntity();
        UserGeodataDto patchDto = createPatchUserGeodataDto();
        UserGeodata patchEntity = userGeodataMapper.toEntity(patchDto);

        userGeodataMapper.partialUpdate(actualEntity, patchDto);
     ...
     */
    @Test
    void shouldReturnEmptyUserGeodataDtoListForNullOrEmptyUserGeodataList() {
        assertThat(userGeodataMapper.toDTOList(null)).isEmpty();
        assertThat(userGeodataMapper.toDTOList(List.of())).isEmpty();
    }
     ...
     */
    @Test
    void shouldReturnEmptyUserGeodataListForNullOrEmptyUserGeodataDtoList() {
        assertThat(userGeodataMapper.toEntityList(null)).isEmpty();
        assertThat(userGeodataMapper.toEntityList(List.of())).isEmpty();
    }
    ...
    void shouldIgnoreNullArgumentsInPartialUpdate() {
        ...
        userGeodataMapper.partialUpdate(entity, null);
        userGeodataMapper.partialUpdate(null, createPatchUserGeodataDto());
    ...
    /**
     * Creates a populated UserGeodata fixture for mapper tests.
     *
    ...
    /**
     * Creates a populated UserGeodataDto fixture for mapper tests.
     *
